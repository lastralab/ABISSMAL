...
Prior to starting this vignette, it would be very helpful if you could complete the brief Google form for a pre-vignette evaluation that will help us learn more about your experience in R and data science with biological datasets prior to completing these vignettes, and what types of skills you're hoping to improve. Your responses in this pre-vignette form will help us continue to improve these vignettes over time. A link to this Google form will be available in the README file for the vignettes.
