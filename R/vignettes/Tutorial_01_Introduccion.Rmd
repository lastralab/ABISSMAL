...
En este primer tutorial, vas a leer sobre el programa RStudio, aprender como crear una versión local de el repositorio de ABISSMAL en GitHub, y aprender más sobre el flujo de análisis de datos en ABISSMAL. En este tutorial vas a aprender como:
