...
sim_dats_rfid %>% 
  dplyr::filter(day == 1) %>% 
  # Escribe el dataframe filtrado como una hoja de cálculo en formato .csv. No incluyes nombres para las filas
...
# Esto puede ser un solo vector en vez de una lista porque quieres guardar el mismo número de días por sensor, pero una lista es útil por si quieres cambiar los días mismos o el número de días que quieres guardar por sensor
days <- list(
  `RFID` = c(1, 2, 3),
  `IRBB` = c(1, 2, 3)
)
