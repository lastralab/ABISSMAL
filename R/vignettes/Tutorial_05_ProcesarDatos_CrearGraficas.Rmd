...
Los colores de las líneas se asignaran automáticamente por `ggplot` usando los colores por defecto del paquete, pero puedes cambiar estos colores usando la función `scale_color_manual()`:
```{r}
