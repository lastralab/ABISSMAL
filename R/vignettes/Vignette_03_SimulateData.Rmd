...
/* Code inside of chunks (including output) */
pre code {
...
In the next vignette, you will write out the simulated RFID and IRBB data to spreadsheets and then you'll use this data to start the ABISSMAL data processing and analysis workflow.