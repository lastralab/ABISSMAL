...
test_that("The function labels entrances and exits as expected using data from 2 beam breaker pairs and integrating perching data", {
...
test_that("The function labels entrances and exits as expected using data from RFID and 2 beam breaker pairs and integrating perching data", {
