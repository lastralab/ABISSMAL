...
#' @param rfid_dir A character string. This argument should be the name of directory where the pre-processed RFID data is saved across sensors inside the path above. For instance, "pre-processed"
#' @param irbb_dir A character string. This argument should be the name of directory where the pre-processed and labeled beam breaker data is saved across sensors inside the path above. For instance, "pre-processed"
#' @param video_dir A character string. This argument should be the name of directory where the pre-processed video data is saved across sensors inside the path above. For instance, "pre-processed"
