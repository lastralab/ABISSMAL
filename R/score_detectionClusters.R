            ...
            if(!is.na(edges[1])){
              ...
              if(!is.null(rfid_label)){
                ...
                if(grepl(rfid_label, edges[1]) & grepl(paste(c(outer_irbb_label, inner_irbb_label), collapse = "|"), edges[1])){
                  ...
                  rfid_inner_irbb_direction <- rfid_outer_irbb_direction <- NA
              ...
              if(!is.null(camera_label)){
                ...
                if(grepl(camera_label, edges[1]) & grepl(paste(c(outer_irbb_label, inner_irbb_label), collapse = "|"), edges[1])){
                  ...
                  inner_irbb_camera_direction <- outer_irbb_camera_direction <- NA
              ...
              if(is.null(rfid_label) | is.null(camera_label) & !is.null(outer_irbb_label) & !is.null(inner_irbb_label)){
                ...
                if(!grepl("Camera|RFID", edges[1]) & grepl(paste(c(outer_irbb_label, inner_irbb_label), collapse = "|"), edges[1])){
                  ...
                  outer_inner_irbb_direction <- NA
                  
                }
                
              } else if(!is.null(rfid_label) & !is.null(camera_label) & is.null(outer_irbb_label) & is.null(inner_irbb_label)){
