...
# TKTK also need to add back video metadata...in both functions!!

score_detectionClusters <- function(file_nm, sensor_id_col, timestamps_col, PIT_tag_col, general_metadata_cols, integrate_perching, path, data_dir, out_dir, out_file_nm = "scored_detectionBursts.csv", tz, POSIXct_format = "%Y-%m-%d %H:%M:%OS"){
