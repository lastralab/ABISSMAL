...
#' 
score_detectionClusters <- function(file_nm, sensor_id_col, timestamps_col, PIT_tag_col, rfid_label, camera_label, outer_irbb_label, inner_irbb_label, general_metadata_cols, video_metadata_cols, integrate_perching, perching_dataset = NULL, perching_prefix = NULL, path, data_dir, out_dir, out_file_nm = "scored_detectionClusters.csv", tz, POSIXct_format = "%Y-%m-%d %H:%M:%OS"){
